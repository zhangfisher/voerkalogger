...
* **core:** 修复`destroy`时执行`flush`逻辑 ([f20d6ec](https://gitee.com/zhangfisher/voerkalogger/commits/f20d6ecb4186e1a30c75f85b01f51edb5fd9b4b3))
...
* **core:** transoirt新增加destroy方法 ([310b5db](https://gitee.com/zhangfisher/voerkalogger/commits/310b5dbd3c2597ad7ebb53d011cd01c8f2d3c609))
